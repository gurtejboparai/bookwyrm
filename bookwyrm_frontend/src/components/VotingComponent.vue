...
export default {
  ...
  computed: {
    ...
    upVoteColour() {
      return (this.localUpVote.includes(localStorage.getItem("username")))?"#8c271e":"#d9f7fa"
    },
    downVoteColour() {
      return (this.localDownVote.includes(localStorage.getItem("username")))?"#8c271e":"#d9f7fa"
    }
  }
};
</script>
